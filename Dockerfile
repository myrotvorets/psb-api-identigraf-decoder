FROM myrotvorets/node:latest@sha256:3adf4e356715a66f2d7322b80c537abcd77b21e60d96ec0210bfb2b3eabdd6e3 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:7cec6ef16a0a660a37cab166250d0dd1fb83e0d442290c0dcf68bfc93335dbff
USER root
WORKDIR /srv/service
