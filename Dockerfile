FROM myrotvorets/node:latest@sha256:e727ceaa2d7cacc0d39857c45dcde5df093ade4bdc7ada9960572bc5c36ed533 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:50dbb7846a054df422767fdd720fa984ee74e6010c588f98c583daa265dce8e1
USER root
WORKDIR /srv/service
