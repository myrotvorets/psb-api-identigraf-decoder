FROM myrotvorets/node:latest@sha256:17b035dfcc7c50a4637043a797f726b8a2e8724dcf951fb11c7baa38832add87 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:ed970f62663997fd30baa61d2683b619ae648ce9d2d5c0a5486a7ea9f637d2dc
USER root
WORKDIR /srv/service
