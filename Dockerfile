FROM myrotvorets/node:latest@sha256:6d5e94431cd791681820bc97ab60a96c70f39ba54f39aa4e652fa23c924e6905 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:741e488ac4aea64fa3dcf61dba1723d1447dd470e34026fcd10bee09281aeddb
USER root
WORKDIR /srv/service
