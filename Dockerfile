FROM myrotvorets/node:latest@sha256:bbc32218956e67188ade2514b60892eddb9dc4b09f1e0fbd0f9e63cc531c443c AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:60cecb96c8bbcd16155314a934274e74163b05f175634fc0ab85d80486c9110f
USER root
WORKDIR /srv/service
