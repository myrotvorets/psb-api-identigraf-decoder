FROM myrotvorets/node:latest@sha256:8cb179eb0cd06f9ad1b05e8bfd9a3433ddff5b8b3a09a47cf7edff5cd74a45ec AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:54474976c3010222dd95ed09e6f7db6fe8b2cf75fd8ec24f907d8c82a8ae4292
USER root
WORKDIR /srv/service
