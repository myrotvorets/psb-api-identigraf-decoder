FROM myrotvorets/node:latest@sha256:316f5d97dbee17b992986e234a02b0f1b687fc615512ca1df380f9401df9c0c7 AS base
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:6ea1e7fd6edb513c4e8f7ffb10f9d830ad8ec10af89d9f2bedc34690d0175872
USER root
WORKDIR /srv/service
