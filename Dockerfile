FROM myrotvorets/node:latest@sha256:46a581875a2ea51e0bfb4493a7d2f37da26b4b15e24eac372d6b89cba63ac942 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:332a472a75984aa127b313971fc404991e2b8b0757f922913a96545431d760c7
USER root
WORKDIR /srv/service
